...
Some technologies/languages I enjoy working with include JavaScript, C++, AWS (currently studying for the Developer Associate <br> Certification), Xcode, React.js, Figma, Flutter, Adobe Photoshop, etc. I am an active member of [CodePath](https://www.codepath.org/), [AnitaB.org](https://anitab.org/), [Rewriting The Code (RTC)](https://rewritingthecode.org/), and other related orgs.    
